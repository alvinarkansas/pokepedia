  ...
  return (
    <StyledLoading>
      <svg width="40" height="40" viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg">
        <path d="M19 15H21V17H19V15Z" fill="#132529" />
        <path d="M19 12H17V10H15V12H17V14H19V12Z" fill="#132529" />
        <path d="M19 12V10H21V12H19Z" fill="#132529" />
        <path d="M21 14V12H23V14H21Z" fill="#132529" />
        <path d="M23 12V10H25V12H23Z" fill="#132529" />
        <path d="M21 23H19V25H21V23Z" fill="#132529" />
        <path
          fillRule="evenodd"
          clipRule="evenodd"
